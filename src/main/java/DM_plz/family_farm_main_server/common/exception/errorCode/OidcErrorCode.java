...
public enum OidcErrorCode implements ErrorCode {
	...
	INVALID_PUBLIC_KEY(HttpStatus.INTERNAL_SERVER_ERROR, "OIDC-0002", "public 키가 유효하지 않습니다."),

	// [FAIL]
	FAIL_TO_GET_JWK(HttpStatus.INTERNAL_SERVER_ERROR, "OIDC-0003", "jwk를 가져오는데 실패했습니다.");
