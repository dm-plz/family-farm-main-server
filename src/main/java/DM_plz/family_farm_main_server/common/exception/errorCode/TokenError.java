...
public enum TokenError implements ErrorCode {
	...
	// [EXPIRED]
	EXPIRED_ACCESS_TOKEN(HttpStatus.BAD_REQUEST, "TOKEN-0001", "만료된 access token 입니다. token을 재발급 하세요."),
	EXPIRED_REFRESH_TOKEN(HttpStatus.BAD_REQUEST, "TOKEN-0002", "만료된 refresh token 입니다. 다시 로그인하세요."),
	NOT_EXPIRED_ACCESS_TOKEN(HttpStatus.BAD_REQUEST, "TOKEN-0003", "access token이 만료되지 않았습니다."),
